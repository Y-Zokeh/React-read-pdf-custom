...
// pdfjsLib.GlobalWorkerOptions.workerSrc = "/pdf.worker.custom.js";
// default scale
    ...
    return <div className='mobile__pdf__container'>
      ...
      </div>
      {
        showFooter && <footer>
            ...
            <input type="number" id="pageNumber" className="toolbarField pageNumber" value={this.state.currentPageNumber} size={4}
                   min={1}/>
