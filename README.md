# React-read-pdf-custom
> a mobile-friendly  PDF Reader in browser for React 16.x
>
> Based on 'https://github.com/forthealllight/react-read-pdf.git'
>
> Display electronic signature         20210316
> 
> Modify border compatibility          20210316
...
### 1. Import react-read-pdf-custom  into your react.js project.
...
```bash
npm install --save react-read-pdf-custom
```
Using PDFReader in PC:
```js
import React from 'react';
import { PDFReader } from 'react-read-pdf-custom';
```
Using MobilePDFReader in mobile terminal devices:
```js
import React from 'react';
import { MobilePDFReader } from 'react-read-pdf-custom';
...
react-read-pdf-custom mainly consists of two different components. ***PDFReader and MobilePDFReader***.
